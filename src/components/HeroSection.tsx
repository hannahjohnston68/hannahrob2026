...
const HeroSection: React.FC = () => {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: "url(https://images.unsplash.com/photo-1512389142860-9c449e58a543?w=1500&q=80)",
    ...
    >
      ...
      <motion.div 
        ...
        className={cn(
          ...
          "glass-card rounded-lg bg-wedding-cream/90 shadow-xl backdrop-blur-sm border border-wedding-champagne/30"
        )}
      >
        <motion.div 
          initial={{
