          ...
          {isMobile ? <>
              ...
              {isOpen && <div className="absolute top-full left-0 right-0 bg-white/95 backdrop-blur-md shadow-lg animate-fade-in py-4">
                  <div className="flex flex-col space-y-2 px-4">
                    <NavLink to="/" className={({isActive}) => cn("py-2 px-4 w-full", isActive ? "text-wedding-pink" : "text-wedding-charcoal")} onClick={() => setIsOpen(false)}>Home</NavLink>
                    <NavLink to="/details" className={({isActive}) => cn("py-2 px-4 w-full", isActive ? "text-wedding-pink" : "text-wedding-charcoal")} onClick={() => setIsOpen(false)}>Details</NavLink>
                    <NavLink to="/gallery" className={({isActive}) => cn("py-2 px-4 w-full", isActive ? "text-wedding-pink" : "text-wedding-charcoal")} onClick={() => setIsOpen(false)}>Gallery</NavLink>
                    <NavLink to="/rsvp" className={({isActive}) => cn("py-2 px-4 w-full", isActive ? "text-wedding-pink" : "text-wedding-charcoal")} onClick={() => setIsOpen(false)}>RSVP</NavLink>
                  </div>
                </div>}
