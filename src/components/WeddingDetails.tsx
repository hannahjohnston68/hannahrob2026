  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center">
        <div className="w-14 h-14 bg-wedding-cream rounded-full flex items-center justify-center mb-4 shadow-inner">
...
const WeddingDetails: React.FC = () => {
  return (
    <section className="py-20 px-4 bg-wedding-sage/20">
