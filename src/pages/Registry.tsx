...
const weddingPartyMembers = [
  {
    ...
    src: `${baseUrl}/images/family/dad.png`,
  },
  {
    name: "Hannah with her Mom",
    role: "Mother of the Bride",
    quote: "A mother's love knows no bounds. Thank you for being my rock and my inspiration.",
    src: `${baseUrl}/images/family/hannah+mum.png`,
  },
  {
    name: "Rob with his Dad",
    role: "Father of the Groom",
    quote: "A father's wisdom and support have helped shape the man I am today.",
    src: `${baseUrl}/images/family/jim.png`,
  },
  {
    name: "Rob with his Mom",
    role: "Mother of the Groom",
    quote: "A mother's love is forever. Thank you for always being there.",
    src: `${baseUrl}/images/family/joanne.png`,
  },
  {
    name: "Rob with Patrick",
    role: "Brothers",
    quote: "Brothers by blood, friends by choice. Thank you for all the memories and adventures.",
    src: `${baseUrl}/images/family/patrick-removebg-preview.png`,
  },
  {
    name: "Hannah with Charlie",
    role: "Siblings",
    quote: "A special bond that only siblings share. Thank you for being my partner in crime.",
    src: `${baseUrl}/images/family/charlie.png`,
  },
  {
    ...
    src: `${baseUrl}/images/friends/kayman.png`,
  },
  {
    ...
    src: `${baseUrl}/images/friends/caitlin.png`,
  },
  {
    name: "Hannah with Camille",
    role: "Bridesmaid",
    quote: "Through all of life's adventures, you've been there with your infectious smile and unwavering support.",
    src: `${baseUrl}/images/friends/camille.png`,
  }
];
